...
def main(args):
    ...
    directory_path = "/fsx/iejmac/code/open_lm/open_lm/eval_set/raven/small/*.npy"
    ...
    with torch.no_grad(), autocast():
        ...
        for file_path in glob.glob(directory_path):
            ...
            losses = []
            for i in range(8):
                batch_x = batch[i:i+1, :-1]
                batch_y = batch[i:i+1, 1:].reshape(-1)
